...
class TimeDuration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets unit
     *
     * @param string|null $unit This enumeration value indicates the time unit used to specify the fulfillment time, such as <code>BUSINESS_DAY</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:TimeDurationUnitEnum'>eBay API documentation</a>
     *
     * @return self
     */
