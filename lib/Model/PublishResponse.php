...
class PublishResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\Error[]|null $warnings This container will contain an array of errors and/or warnings if any occur when a <strong>publishOffer</strong> or <strong>publishOfferByInventoryItemGroup</strong> call is made.
     *
     * @return self
     */
