...
class ShipToLocationAvailabilityWithAll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'allocation_by_format' => '\OpenAPI\Client\Model\FormatAllocation',
        'availability_distributions' => '\OpenAPI\Client\Model\AvailabilityDistribution[]',
        'quantity' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\FormatAllocation|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FormatAllocation|null $allocation_by_format allocation_by_format
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\AvailabilityDistribution[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AvailabilityDistribution[]|null $availability_distributions This container is used to set the available quantity of the inventory item at one or more warehouse locations.<br><br> This container will be returned if the available quantity is set for one or more inventory locations.
     *
     * @return self
     */
