...
```php
bulkCreateOffer($content_language, $content_type, $bulk_ebay_offer_details_with_keys): \OpenAPI\Client\Model\BulkOfferResponse
```
...
```php
bulkPublishOffer($content_type, $bulk_offer): \OpenAPI\Client\Model\BulkPublishResponse
```
...
$content_type = 'content_type_example'; // string | This header indicates the format of the request body provided by the client. Its value should be set to <b>application/json</b>. <br><br> For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.
$bulk_offer = new \OpenAPI\Client\Model\BulkOffer(); // \OpenAPI\Client\Model\BulkOffer | The base request of the <strong>bulkPublishOffer</strong> method.
...
| ------------- | ------------- | ------------- | ------------- |
| **content_type** | **string**| This header indicates the format of the request body provided by the client. Its value should be set to &lt;b&gt;application/json&lt;/b&gt;. &lt;br&gt;&lt;br&gt; For more information, refer to &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#HTTP\&quot; target&#x3D;\&quot;_blank \&quot;&gt;HTTP request headers&lt;/a&gt;. | |
| **bulk_offer** | [**\OpenAPI\Client\Model\BulkOffer**](../Model/BulkOffer.md)| The base request of the &lt;strong&gt;bulkPublishOffer&lt;/strong&gt; method. | |
...
```php
createOffer($content_language, $content_type, $ebay_offer_details_with_keys): \OpenAPI\Client\Model\OfferResponse
```
...
```php
getListingFees($content_type, $offer_keys_with_id): \OpenAPI\Client\Model\FeesSummaryResponse
```
...
```php
getOffer($offer_id): \OpenAPI\Client\Model\EbayOfferDetailsWithAll
```
...
```php
getOffers($format, $limit, $marketplace_id, $offset, $sku): \OpenAPI\Client\Model\Offers
```
...
```php
publishOffer($offer_id): \OpenAPI\Client\Model\PublishResponse
```
...
```php
publishOfferByInventoryItemGroup($content_type, $publish_by_inventory_item_group_request): \OpenAPI\Client\Model\PublishResponse
```
...
```php
updateOffer($content_language, $offer_id, $content_type, $ebay_offer_details_with_id): \OpenAPI\Client\Model\OfferResponse
```
...
```php
withdrawOffer($offer_id): \OpenAPI\Client\Model\WithdrawResponse
```
...
$content_type = 'content_type_example'; // string | This header indicates the format of the request body provided by the client. Its value should be set to <b>application/json</b>. <br><br> For more information, refer to <a href=\"/api-docs/static/rest-request-components.html#HTTP\" target=\"_blank \">HTTP request headers</a>.
$withdraw_by_inventory_item_group_request = new \OpenAPI\Client\Model\WithdrawByInventoryItemGroupRequest(); // \OpenAPI\Client\Model\WithdrawByInventoryItemGroupRequest | The base request of the <strong>withdrawOfferByInventoryItemGroup</strong> call.
...
| ------------- | ------------- | ------------- | ------------- |
| **content_type** | **string**| This header indicates the format of the request body provided by the client. Its value should be set to &lt;b&gt;application/json&lt;/b&gt;. &lt;br&gt;&lt;br&gt; For more information, refer to &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#HTTP\&quot; target&#x3D;\&quot;_blank \&quot;&gt;HTTP request headers&lt;/a&gt;. | |
| **withdraw_by_inventory_item_group_request** | [**\OpenAPI\Client\Model\WithdrawByInventoryItemGroupRequest**](../Model/WithdrawByInventoryItemGroupRequest.md)| The base request of the &lt;strong&gt;withdrawOfferByInventoryItemGroup&lt;/strong&gt; call. | |
