...
```php
createOrReplaceInventoryItemGroup($content_language, $inventory_item_group_key, $content_type, $inventory_item_group): \OpenAPI\Client\Model\BaseResponse
```
...
```php
getInventoryItemGroup($inventory_item_group_key): \OpenAPI\Client\Model\InventoryItemGroup
```
