...
```php
bulkCreateOrReplaceInventoryItem($content_type, $content_language, $bulk_inventory_item): \OpenAPI\Client\Model\BulkInventoryItemResponse
```
...
```php
bulkGetInventoryItem($content_type, $bulk_get_inventory_item): \OpenAPI\Client\Model\BulkGetInventoryItemResponse
```
...
```php
bulkUpdatePriceQuantity($content_type, $bulk_price_quantity): \OpenAPI\Client\Model\BulkPriceQuantityResponse
```
...
```php
createOrReplaceInventoryItem($content_language, $sku, $content_type, $inventory_item): \OpenAPI\Client\Model\BaseResponse
```
...
```php
getInventoryItem($sku): \OpenAPI\Client\Model\InventoryItemWithSkuLocaleGroupid
```
...
```php
getInventoryItems($limit, $offset): \OpenAPI\Client\Model\InventoryItems
```
